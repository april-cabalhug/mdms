...
public class Splash_Form extends JFrame {
	...
	public static void main(String[] args) {
		int x;
			Splash_Form frame = new Splash_Form();
			frame.setVisible(true);
			try {
				for(x=0;x<=100;x++) {
					Splash_Form.progressBar.setValue(x);
					Thread.sleep(50);
					Splash_Form.lblCount_1.setText(Integer.toString(x)+" %");
					if(x==100) {
	...
	public Splash_Form() {
		...
		JLabel lblNewLabel = new JLabel("MODULE DISTRIBUTION MANAGEMENT SYSTEM");
