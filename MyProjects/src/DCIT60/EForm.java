...
public class EForm {
	...
	private JFrame frmBesAdmission;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					EForm window = new EForm();
					window.frmBesAdmission.setVisible(true);
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
	...
	private void initialize() {
		frmBesAdmission = new JFrame();
		frmBesAdmission.setTitle("BES Enrollment");
		frmBesAdmission.getContentPane().setBackground(new Color(220,20,60));
		frmBesAdmission.setBounds(100, 100, 1366, 768);
		frmBesAdmission.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		frmBesAdmission.getContentPane().setLayout(null);
		
		JTabbedPane tabbedPane = new JTabbedPane(JTabbedPane.TOP);
		tabbedPane.setBounds(10, 11, 1340, 718);
		frmBesAdmission.getContentPane().add(tabbedPane);
		...
		panel_9.setBorder(new TitledBorder(new LineBorder(new Color(178, 34, 34)), "G1-6 ENROLLMENT PROFILE", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
		...
		panel_1.setBounds(833, 285, 472, 264);
		panel_9.add(panel_1);
		
		JLabel lblNewLabel_2 = new JLabel("Photocopy of birth certificate/baptismal certificate");
		lblNewLabel_2.setFont(new Font("Arial", Font.PLAIN, 12));
		lblNewLabel_2.setBounds(10, 17, 323, 14);
		...
		panel_2_1.setBounds(61, 42, 350, 45);
		...
		lblNewLabel_2_1.setBounds(10, 98, 144, 14);
		...
		panel_2_1_1.setBounds(61, 123, 350, 45);
		...
		panel_2_1_1.add(lblNewLabel_1_1_2);
		
		JLabel lblNewLabel_3 = new JLabel("Form 137");
		lblNewLabel_3.setFont(new Font("Arial", Font.PLAIN, 12));
		lblNewLabel_3.setBounds(10, 179, 84, 14);
		...
		panel_2_2.setBounds(61, 204, 350, 45);
		...
		btnAdd.setBounds(833, 584, 150, 45);
		panel_9.add(btnAdd);
		...
		btnClear.setBounds(994, 584, 150, 45);
		...
		btnUpdate.setBounds(1155, 584, 150, 45);
		...
		panel_9_1.setBorder(new TitledBorder(new LineBorder(new Color(178, 34, 34)), "KINDER ENROLLMENT PROFILE", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
		...
		panel_1_1.setBounds(833, 285, 472, 264);
		panel_9_1.add(panel_1_1);
		
		JLabel lblNewLabel_2_2 = new JLabel("Photocopy of birth certificate/baptismal certificate");
		lblNewLabel_2_2.setFont(new Font("Arial", Font.PLAIN, 12));
		lblNewLabel_2_2.setBounds(10, 17, 350, 14);
		...
		panel_2_1_2.setBounds(61, 42, 350, 45);
		panel_1_1.add(panel_2_1_2);
		
		JButton btnNewButton_3 = new JButton("Choose File");
		btnNewButton_3.setFont(new Font("Tahoma", Font.PLAIN, 12));
		btnNewButton_3.setBounds(10, 11, 103, 23);
		panel_2_1_2.add(btnNewButton_3);
		
		JLabel lblNewLabel_1_4_1 = new JLabel("No file chosen");
		lblNewLabel_1_4_1.setFont(new Font("Arial", Font.PLAIN, 12));
		lblNewLabel_1_4_1.setBounds(123, 16, 111, 14);
		panel_2_1_2.add(lblNewLabel_1_4_1);
		
		JLabel lblNewLabel_2_1_1 = new JLabel("2x2 ID picture");
		lblNewLabel_2_1_1.setFont(new Font("Arial", Font.PLAIN, 12));
		lblNewLabel_2_1_1.setBounds(10, 98, 153, 14);
		panel_1_1.add(lblNewLabel_2_1_1);
		
		JPanel panel_2_1_1_1 = new JPanel();
		panel_2_1_1_1.setLayout(null);
		panel_2_1_1_1.setBorder(new LineBorder(SystemColor.windowBorder));
		panel_2_1_1_1.setBackground(SystemColor.inactiveCaptionBorder);
		panel_2_1_1_1.setBounds(61, 123, 350, 45);
		...
		panel_2_1_1_1.add(btnNewButton_1_1);
		
		JLabel lblNewLabel_1_1_2_1 = new JLabel("No file chosen");
		lblNewLabel_1_1_2_1.setFont(new Font("Arial", Font.PLAIN, 12));
		lblNewLabel_1_1_2_1.setBounds(123, 16, 111, 14);
		panel_2_1_1_1.add(lblNewLabel_1_1_2_1);
		
		JLabel lblNewLabel_3_1 = new JLabel("Form 137");
		lblNewLabel_3_1.setFont(new Font("Arial", Font.PLAIN, 12));
		lblNewLabel_3_1.setBounds(10, 179, 84, 14);
		...
		panel_2_2_1.setBounds(61, 204, 350, 45);
		...
		JLabel lblNewLabel_1_2_1_1 = new JLabel("No file chosen");
		lblNewLabel_1_2_1_1.setFont(new Font("Arial", Font.PLAIN, 12));
		lblNewLabel_1_2_1_1.setBounds(123, 16, 111, 14);
		panel_2_2_1.add(lblNewLabel_1_2_1_1);
		
		JButton btnAdd_1 = new JButton("ADD");
		btnAdd_1.setForeground(Color.WHITE);
		btnAdd_1.setFont(new Font("Lucida Console", Font.BOLD, 14));
		btnAdd_1.setBorder(new BevelBorder(BevelBorder.RAISED, null, null, null, null));
		btnAdd_1.setBackground(new Color(220, 20, 60));
		btnAdd_1.setBounds(833, 584, 150, 45);
		panel_9_1.add(btnAdd_1);
		
		JButton btnClear_1 = new JButton("CLEAR");
		btnClear_1.setForeground(Color.WHITE);
		btnClear_1.setFont(new Font("Lucida Console", Font.BOLD, 14));
		btnClear_1.setBorder(new BevelBorder(BevelBorder.RAISED, null, null, null, null));
		btnClear_1.setBackground(new Color(220, 20, 60));
		btnClear_1.setBounds(994, 584, 150, 45);
		panel_9_1.add(btnClear_1);
		
		JButton btnUpdate_1 = new JButton("UPDATE");
		btnUpdate_1.setForeground(Color.WHITE);
		btnUpdate_1.setFont(new Font("Lucida Console", Font.BOLD, 14));
		btnUpdate_1.setBorder(new BevelBorder(BevelBorder.RAISED, null, null, null, null));
		btnUpdate_1.setBackground(new Color(220, 20, 60));
		btnUpdate_1.setBounds(1155, 584, 150, 45);
		panel_9_1.add(btnUpdate_1);
		...
		panel_9_2.setBorder(new TitledBorder(new LineBorder(new Color(178, 34, 34)), "ALS ENROLLMENT PROFILE", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
		...
		panel_1_2.setBounds(882, 419, 423, 185);
		panel_9_2.add(panel_1_2);
		
		JLabel lblNewLabel_2_4 = new JLabel("Photocopy of birth certificate/baptismal certificate");
		lblNewLabel_2_4.setFont(new Font("Arial", Font.PLAIN, 12));
		lblNewLabel_2_4.setBounds(10, 17, 328, 14);
		panel_1_2.add(lblNewLabel_2_4);
		
		JPanel panel_2_1_4 = new JPanel();
		panel_2_1_4.setLayout(null);
		panel_2_1_4.setBorder(new LineBorder(SystemColor.windowBorder));
		panel_2_1_4.setBackground(SystemColor.inactiveCaptionBorder);
		panel_2_1_4.setBounds(35, 42, 350, 45);
		panel_1_2.add(panel_2_1_4);
		
		JButton btnNewButton_4 = new JButton("Choose File");
		btnNewButton_4.setFont(new Font("Tahoma", Font.PLAIN, 12));
		btnNewButton_4.setBounds(10, 11, 103, 23);
		panel_2_1_4.add(btnNewButton_4);
		
		JLabel lblNewLabel_1_4_2 = new JLabel("No file chosen");
		lblNewLabel_1_4_2.setFont(new Font("Arial", Font.PLAIN, 12));
		lblNewLabel_1_4_2.setBounds(123, 16, 111, 14);
		panel_2_1_4.add(lblNewLabel_1_4_2);
		
		JLabel lblNewLabel_2_1_2 = new JLabel("2x2 ID picture");
		lblNewLabel_2_1_2.setFont(new Font("Arial", Font.PLAIN, 12));
		lblNewLabel_2_1_2.setBounds(10, 98, 143, 14);
		panel_1_2.add(lblNewLabel_2_1_2);
		
		JPanel panel_2_1_1_2 = new JPanel();
		panel_2_1_1_2.setLayout(null);
		panel_2_1_1_2.setBorder(new LineBorder(SystemColor.windowBorder));
		panel_2_1_1_2.setBackground(SystemColor.inactiveCaptionBorder);
		panel_2_1_1_2.setBounds(35, 123, 350, 45);
		panel_1_2.add(panel_2_1_1_2);
		...
		panel_2_1_1_2.add(btnNewButton_1_2);
		
		JLabel lblNewLabel_1_1_2_2 = new JLabel("No file chosen");
		lblNewLabel_1_1_2_2.setFont(new Font("Arial", Font.PLAIN, 12));
		lblNewLabel_1_1_2_2.setBounds(123, 16, 111, 14);
		panel_2_1_1_2.add(lblNewLabel_1_1_2_2);
		
		JButton btnAdd_1_1_1 = new JButton("ADD");
		btnAdd_1_1_1.setForeground(Color.WHITE);
		btnAdd_1_1_1.setFont(new Font("Lucida Console", Font.BOLD, 14));
		btnAdd_1_1_1.setBorder(new BevelBorder(BevelBorder.RAISED, null, null, null, null));
		btnAdd_1_1_1.setBackground(new Color(220, 20, 60));
		btnAdd_1_1_1.setBounds(882, 615, 120, 40);
		panel_9_2.add(btnAdd_1_1_1);
		
		JButton btnClear_1_1_1 = new JButton("CLEAR");
		btnClear_1_1_1.setForeground(Color.WHITE);
		btnClear_1_1_1.setFont(new Font("Lucida Console", Font.BOLD, 14));
		btnClear_1_1_1.setBorder(new BevelBorder(BevelBorder.RAISED, null, null, null, null));
		btnClear_1_1_1.setBackground(new Color(220, 20, 60));
		btnClear_1_1_1.setBounds(1034, 615, 120, 40);
		panel_9_2.add(btnClear_1_1_1);
		
		JButton btnUpdate_1_1_1 = new JButton("UPDATE");
		btnUpdate_1_1_1.setForeground(Color.WHITE);
		btnUpdate_1_1_1.setFont(new Font("Lucida Console", Font.BOLD, 14));
		btnUpdate_1_1_1.setBorder(new BevelBorder(BevelBorder.RAISED, null, null, null, null));
		btnUpdate_1_1_1.setBackground(new Color(220, 20, 60));
		btnUpdate_1_1_1.setBounds(1185, 615, 120, 40);
		panel_9_2.add(btnUpdate_1_1_1);
		...
		panel_9_1_1.setBorder(new TitledBorder(new LineBorder(new Color(178, 34, 34)), "SPED ENROLLMENT PROFILE", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
		...
		btnAdd_1_1.setFont(new Font("Lucida Console", Font.BOLD, 14));
		btnAdd_1_1.setBorder(new BevelBorder(BevelBorder.RAISED, null, null, null, null));
		btnAdd_1_1.setBackground(new Color(220, 20, 60));
		btnAdd_1_1.setBounds(833, 587, 150, 45);
		panel_9_1_1.add(btnAdd_1_1);
		
		JButton btnClear_1_1 = new JButton("CLEAR");
		btnClear_1_1.setForeground(Color.WHITE);
		btnClear_1_1.setFont(new Font("Lucida Console", Font.BOLD, 14));
		btnClear_1_1.setBorder(new BevelBorder(BevelBorder.RAISED, null, null, null, null));
		btnClear_1_1.setBackground(new Color(220, 20, 60));
		btnClear_1_1.setBounds(994, 587, 150, 45);
		panel_9_1_1.add(btnClear_1_1);
		
		JButton btnUpdate_1_1 = new JButton("UPDATE");
		btnUpdate_1_1.setForeground(Color.WHITE);
		btnUpdate_1_1.setFont(new Font("Lucida Console", Font.BOLD, 14));
		btnUpdate_1_1.setBorder(new BevelBorder(BevelBorder.RAISED, null, null, null, null));
		btnUpdate_1_1.setBackground(new Color(220, 20, 60));
		btnUpdate_1_1.setBounds(1155, 587, 150, 45);
		panel_9_1_1.add(btnUpdate_1_1);
		...
		panel_1_3.setBounds(833, 285, 472, 274);
		...
		lblBirthCertificate.setBounds(10, 19, 274, 14);
		...
		panel_2_5.setBounds(60, 33, 350, 45);
		...
		lblNewLabel_2_3.setBounds(10, 89, 148, 14);
		...
		panel_2_1_3.setBounds(60, 103, 350, 45);
		...
		lblNewLabel_3_3.setBounds(10, 174, 148, 14);
		...
		panel_2_2_3.setBounds(60, 188, 350, 45);
		...
		lblNewLabel_6.setBounds(60, 149, 350, 14);
		...
		lblNewLabel_6_1.setBounds(60, 234, 350, 14);
